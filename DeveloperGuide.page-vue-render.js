...
with(this){return _c('ul',[_c('li',[_v("Administrative staff at a GP clinic responsible for patient management.")]),_v(" "),_c('li',[_v("should be apt with technology and trained to be familiar with the software as their primary job")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("New user")]),_v(" "),_c('td',[_v("add a new contact with multiple phone numbers (e.g. home, mobile, email address)")]),_v(" "),_c('td',[_v("manage patient contact information and have multiple options for reaching them in an emergency.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("save addresses")]),_v(" "),_c('td',[_v("have their location readily available.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("delete a contact")]),_v(" "),_c('td',[_v("remove outdated or incorrect contact information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("list all contacts in one dashboard")]),_v(" "),_c('td',[_v("easily view all the contacts that I have added.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("find the patient contact by a keyword (e.g. name, phone numbers)")]),_v(" "),_c('td',[_v("search the patients’ contact instantly.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("edit an existing patient contact")]),_v(" "),_c('td',[_v("update their details when necessary.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("see all the texts and UI clearly")]),_v(" "),_c('td',[_v("avoid squinting my eyes")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("import contacts from a file")]),_v(" "),_c('td',[_v("quickly fill in the address book with existing contact information.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("export contacts to a file securely")]),_v(" "),_c('td',[_v("share them with other authorized personnel or have a backup.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Silly user")]),_v(" "),_c('td',[_v("receive confirmation before deleting a contact")]),_v(" "),_c('td',[_v("prevent accidentally deleting important information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("sort the patients according to appointment dates")]),_v(" "),_c('td',[_v("easily know which are the latest upcoming appointments")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("add a contact to my favorite list")]),_v(" "),_c('td',[_v("quickly access important contacts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("see alerts of duplicate contacts in the app")]),_v(" "),_c('td',[_v("keep the contact list clean and avoid redundancy and confusion")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("tag patients with recurring appointments")]),_v(" "),_c('td',[_v("know which patients need regular follow ups")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Expert User")]),_v(" "),_c('td',[_v("record patients' medical conditions, assigned doctor(s) and/or treatment plan")]),_v(" "),_c('td',[_v("prioritize urgent conditions and streamline patient management.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("add notes to a contact")]),_v(" "),_c('td',[_v("remember important information about that person.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("filter patients based on appointment dates")]),_v(" "),_c('td',[_v("contact and remind them.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("filter patients based on age groups")]),_v(" "),_c('td',[_v("prioritize patients who fall within a certain age group.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Potential user")]),_v(" "),_c('td',[_v("see the app populated with some sample commands")]),_v(" "),_c('td',[_v("easily learn how to use the app.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("User")]),_v(" "),_c('td',[_v("use the app to work offline")]),_v(" "),_c('td',[_v("use it even when there is no internet connection.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to clear address book.")])]),_v(" "),_c('li',[_c('p',[_v("MediContact requests for confirmation.")])]),_v(" "),_c('li',[_c('p',[_v("User confirms to clear.")])]),_v(" "),_c('li',[_c('p',[_v("MediContact clears all contacts in MediContact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. User chooses to cancel the clear action.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Technical:\n"),_c('ul',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java 17 or above installed.")]),_v(" "),_c('li',[_v("Should work on both 32-bit and 64-bit environments.")])])]),_v(" "),_c('li',[_v("Performance:\n"),_c('ul',[_c('li',[_v("Should be able to hold up to 1000 contacts without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("The response to any use action should become visible within 3 seconds.")]),_v(" "),_c('li',[_v("Should not crash when the input is too long.")])])]),_v(" "),_c('li',[_v("Quality:\n"),_c('ul',[_c('li',[_v("Should be easy to learn for a novice who has never used CLI before.")]),_v(" "),_c('li',[_v("The product is offered as a free downloadable application.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Encryption")]),_v(": The process of converting data into a code to prevent unauthorized access, typically using algorithms and keys.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a patient")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all patients using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple patients in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan Lim p/98765432 e/bryan@example.com a/5 Hilly Road b/23 s/Male")]),_c('br'),_v("\nExpected: Bryan Lim is added to the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan_Lim p/98765432 e/bryan@example.com a/5 Hilly Road b/23 s/Male")]),_c('br'),_v("\nExpected: No contact is added to the list, error message regarding name should be shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan Lim p/000 e/bryan@example.com a/5 Hilly Road b/23 s/Male")]),_c('br'),_v("\nExpected: No contact is added to the list, error message regarding phone number should be shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan Lim p/98765432 e/bryan a/5 Hilly Road b/23 s/Male")]),_c('br'),_v("\nExpected: No contact is added to the list, error message regarding email should be shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan Lim p/98765432 e/bryan@example.com a/ b/23 s/Male")]),_c('br'),_v("\nExpected: No contact is added to the list, error message regarding address should be shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan Lim p/98765432 e/bryan@example.com a/5 Hilly Road b/twelve s/Male")]),_c('br'),_v("\nExpected: No contact is added to the list, error message regarding age should be shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan Lim p/98765432 e/bryan@example.com a/5 Hilly Road b/23 s/")]),_c('br'),_v("\nExpected: No contact is added to the list, error message regarding gender should be shown.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding a duplicate patient")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all patients using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple patients in the list."),_c('br'),_v("\nPerson with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Bryan Lim")]),_v(" should already be in list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan Lim p/00000000 e/different_bryan@example.com a/5 Hilly Road b/23 s/Male")]),_c('br'),_v("\nExpected: No contact is added to the list, error message regarding patient already existing should be shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Bryan Sim p/00000000 e/different_bryan@example.com a/5 Hilly Road b/23 s/Male")]),_c('br'),_v("\nExpected: Bryan Lim is added to the list.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"clearing-the-address-book"}},[_v("Clearing the address book"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#clearing-the-address-book","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Clearing the address book")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_c('br'),_v("\nExpected: Alert pop up confirming whether you want to clear the address book.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: Click on "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("OKAY")]),_c('br'),_v("\nExpected: Address book is cleared")])]),_v(" "),_c('li',[_c('p',[_v("Test case: Click on "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Cancel")]),_c('br'),_v("\nExpected: Address book is unchanged")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a patient via index while all patients are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all patients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple patients in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: Confirmation dialog is triggered. "),_c('br'),_c('br'),_v("If confirmed, first contact is deleted from the list. Message reflecting delete action successful is shown.\n"),_c('br'),_c('br'),_v("If cancelled, no patient is deleted, message reflecting delete action being cancelled is shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("\nExpected: No patient is deleted. Error details shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])])]),_v(" "),_c('li',[_c('p',[_v("Deleting a patient via name while all patients are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all patients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple patients in the list."),_c('br'),_v("\nJohn Doe is an existing contact")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete John Doe")]),_c('br'),_v("\nExpected: Confirmation dialog is triggered. "),_c('br'),_c('br'),_v("If confirmed, John Doe is deleted from the list. Message reflecting delete action successful is shown.\n"),_c('br'),_c('br'),_v("If cancelled, no patient is deleted, message reflecting delete action being cancelled is shown.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete Jane Doe")]),_c('br'),_v("\nExpected: No patient is deleted. Error details shown in the status message.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Editing a patient's fields")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Person named "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" must exist.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe n/Jane Doe")]),_c('br'),_v("\nExpected: Contact with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" is changed to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Jane Doe")])])]),_v(" "),_c('li',[_c('p',[_v("Other test cases to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe a/6 Sunny Road")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe b/35")]),_v(", etc"),_c('br'),_v("\nExpected: Similar to previous results with relevant fields changed")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe n/John Doe")]),_c('br'),_v("\nExpected: Error message reflecting no changes detected")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe n/John Doe b/35")]),_v(" (given that John Doe's age is not 35) "),_c('br'),_v("\nExpected: Contact with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" has age updated to 35")])])])]),_v(" "),_c('li',[_c('p',[_v("Editing a non-existent patient's field")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Person named "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" must not exist.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe n/Jane Doe")]),_c('br'),_v("\nExpected: Error message reflecting provided name is invalid")])]),_v(" "),_c('li',[_c('p',[_v("Other test cases to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe a/6 Sunny Road")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe b/35")]),_v(", etc"),_c('br'),_v("\nExpected: Similar to previous results.")])])])]),_v(" "),_c('li',[_c('p',[_v("Editing a patient with no fields")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe")]),_c('br'),_v("\nExpected: Error message reflecting at least one field must be provided.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit Non Existent Person")]),_c('br'),_v("\nExpected: Similar to previous results.")])])])]),_v(" "),_c('li',[_c('p',[_v("Clearing a patients appointments and tags")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Person named "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" must exist.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe t/")]),_c('br'),_v("\nExpected: Contact with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" has all existing tags cleared")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit John Doe ap/")]),_c('br'),_v("\nExpected: Contact with name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" has all existing appointments cleared")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"filter-the-contacts-list"}},[_v("Filter the contacts list"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#filter-the-contacts-list","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Filtering by Age range")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Address book should have a number of contacts in order to make testing meaningful")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter b/20 - 30")]),_c('br'),_v("Expected: All contacts with ages 20 - 30 inclusive should be displayed")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter b/30 - 20")]),_c('br'),_v("\nExpected: Error reflecting how upper bound should be at least equal or greater than lower bound is displayed")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter b/200-200")]),_v(" (Assuming no contact has age 200)"),_c('br'),_v("\nExpected: Message will display no contact fits the criteria, list of people remain the same")])])])]),_v(" "),_c('li',[_c('p',[_v("Filtering by Appointment range")]),_v(" "),_c('ol',[_c('li',[_v("Test cases to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter ap/01/01/2024 - 01/01/2025")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter ap/01/01/2025 - 01/01/2024")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter ap/01/01/2024 - 01/01/2024")]),_c('br'),_v("\nExpected: Similar results to filtering by age")])])]),_v(" "),_c('li',[_c('p',[_v("Filtering by Tags")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Address book should have a number of contacts in order to make testing meaningful.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter t/patients")]),_c('br'),_v("Expected: All contacts with tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("patients")]),_v(" should be displayed.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter t/")]),_c('br'),_v("\nExpected: Error reflecting how input should be alphanumerical.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter b/son")]),_v(" (Assuming no contact has tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("son")]),_v(")"),_c('br'),_v("\nExpected: Message will display no contact fits the criteria, list of people remain the same.")])])])]),_v(" "),_c('li',[_c('p',[_v("Filtering using multiple criteria")]),_v(" "),_c('ol',[_c('li',[_v("Test cases to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter b/20 - 30 t/patient")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter ap/01/01/2025 - 01/01/2024 t/diabetes")]),_v("\nExpected: Only contacts that satisfy all criteria are shown. If no matches, list is not changed and message will display no contact fits the criteria.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Finding someone that exists")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List should contain contacts with the names and phone numbers that you want to find.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find bryan")]),_v(" "),_c('br'),_v("Expected: All contacts with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("bryan")]),_v(" in their name is displayed.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find 987654321")]),_v(" "),_c('br'),_v("Expected: All contacts with phone number "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("987654321")]),_v(" is displayed.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find bry 9876")]),_v(" "),_c('br'),_v("Expected: All contacts with "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("bry")]),_v(" in their name or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("9876")]),_v(" in their phone number is displayed.")])])])]),_v(" "),_c('li',[_c('p',[_v("Finding someone that does not exist")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List should not contain contacts with the names and phone numbers that you want to find.")])]),_v(" "),_c('li',[_c('p',[_v("Test case to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find somebody")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find somebody 99999999")]),_v(" "),_c('br'),_v("Expected: Message displays that no one matches the criteria and list of contacts remain the same.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("List all contacts")]),_v(" "),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_c('br'),_v("\nExpected: All contacts are listed")])])]),_v(" "),_c('li',[_c('p',[_v("List all starred contacts (Contacts have been Starred)")]),_v(" "),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list *")]),_c('br'),_v("\nExpected: All Starred contacts are listed")])])]),_v(" "),_c('li',[_c('p',[_v("List all starred contacts (No contacts have been Starred)")]),_v(" "),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list *")]),_c('br'),_v("\nExpected: Message reflects that no contacts have been starred")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"editing-a-contact-s-notes"}},[_v("Editing a contact's notes"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#editing-a-contact-s-notes","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding new notes to an existing patient")]),_v(" "),_c('ol',[_c('li',[_v("Test cases: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("note Bryan ap/01/01/2025 r/Allergic to Ibuprofen")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("note John m/10mg Panadol")]),_c('br'),_v("\nExpected: Notes are added to patient (Behaviour is very similar to Edit Command's appointments and tags)")])])]),_v(" "),_c('li',[_c('p',[_v("Removing note's fields of an existing patient")]),_v(" "),_c('ol',[_c('li',[_v("Test cases: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("note Bryan ap/ r/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("note John m/")]),_c('br'),_v("\nExpected: Respective Note fields are removed (Behaviour is very similar to Edit Command's appointments and tags)")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Sorting list by appointment dates")]),_v(" "),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_c('br'),_v("\nExpected: List is sorted by appointment dates. Contacts with no appointments are at the end, sorted alphabetically.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Starring an unstarred patient")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisite: Address book is populated with contacts.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("star 1")]),_c('br'),_v("\nExpected: Contact at index 1 is starred")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("star John")]),_c('br'),_v("\nExpected: Contact with exact name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John")]),_v(" is starred")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("star 0")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("star -1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("star x")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Error message reflecting index provided is invalid")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("star somebody")]),_c('br'),_v("\nExpected: Error message reflecting name provided is invalid")])])])]),_v(" "),_c('li',[_c('p',[_v("Starring a starred patient")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisite: First contact is starred")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("star 1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("star x")]),_v(" (where x is the name of the first contact)"),_c('br'),_v("\nExpected: Message reflects that contact has already been starred")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"unstarring-a-contact"}},[_v("Unstarring a contact"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#unstarring-a-contact","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Unstarring a starred patient")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisite: Address book is populated with contacts.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unstar 1")]),_c('br'),_v("\nExpected: Contact at index 1 is unstarred")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unstar John")]),_c('br'),_v("\nExpected: Contact with exact name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John")]),_v(" is unstarred")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unstar 0")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unstar -1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unstar x")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Error message reflecting index provided is invalid")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unstar somebody")]),_c('br'),_v("\nExpected: Error message reflecting name provided is invalid")])])])]),_v(" "),_c('li',[_c('p',[_v("Starring a starred patient")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisite: First contact is unstarred")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unstar 1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("unstar x")]),_v(" (where x is the name of the first contact)"),_c('br'),_v("\nExpected: Message reflects that contact is not starred")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"viewing-a-contacts-details"}},[_v("Viewing a contacts details"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#viewing-a-contacts-details","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Viewing an existent patient")]),_v(" "),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view 1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view John")]),_c('br'),_v("\nExpected: Person's details are shown")])])]),_v(" "),_c('li',[_c('p',[_v("Viewing a non-existent patient")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view 0")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view -1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view x")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Error message reflecting index provided is invalid.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("view somebody")]),_c('br'),_v("\nExpected: Error message reflecting name provided is invalid.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Data Management")]),_v(": Handling multiple entity types required a robust data model and efficient data handling mechanisms.")]),_v(" "),_c('li',[_c('strong',[_v("User Interface")]),_v(": Designing a user-friendly interface that integrates seamlessly with the underlying logic and data models.")]),_v(" "),_c('li',[_c('strong',[_v("Integration with JavaFX")]),_v(": Ensuring smooth integration with JavaFX for the UI components, especially given the non-modular setup.")]),_v(" "),_c('li',[_c('strong',[_v("Performance Optimization")]),_v(": Ensuring the application performs efficiently with a large dataset (up to 1000 contacts) without noticeable sluggishness.")]),_v(" "),_c('li',[_c('strong',[_v("Testing")]),_v(": Comprehensive testing to ensure all functionalities work as expected and the application is robust against invalid inputs.")]),_v(" "),_c('li',[_c('strong',[_v("Complex Codebase")]),_v(": Starting from a brownfield project meant working with a complex, pre-existing codebase. Understanding and adapting to others' coding styles and logic added a significant challenge, requiring time and careful analysis to ensure seamless integration of new features.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Familiarizing with existing code")]),_v(": Understanding and adapting to others' coding styles and logic added a significant challenge, requiring time and careful analysis to ensure seamless integration of new features.")]),_v(" "),_c('li',[_c('strong',[_v("Design and Architecture")]),_v(": Planning the architecture to handle multiple entities and their interactions.")]),_v(" "),_c('li',[_c('strong',[_v("Implementation")]),_v(": Coding the functionalities, ensuring they work together seamlessly.")]),_v(" "),_c('li',[_c('strong',[_v("Testing")]),_v(": Writing and executing test cases to ensure the application is bug-free and performs well.")]),_v(" "),_c('li',[_c('strong',[_v("Documentation")]),_v(": Producing comprehensive documentation for both developers and users, including a developer guide to explain the system's components and a user guide to ensure understanding of the application's features.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Robust Data Model")]),_v(": Successfully designed and implemented a data model that handles multiple entity types efficiently.")]),_v(" "),_c('li',[_c('strong',[_v("User-Friendly Interface")]),_v(": Developed a user-friendly interface that integrates well with the underlying logic.")]),_v(" "),_c('li',[_c('strong',[_v("Performance")]),_v(": Optimized the application to handle large datasets without performance issues.")]),_v(" "),_c('li',[_c('strong',[_v("Comprehensive Testing")]),_v(": Ensured the application is robust and handles invalid inputs gracefully.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("UI Components")]),_v(": Reused and adapted UI components from AB3, saving time on designing and implementing new UI elements.")]),_v(" "),_c('li',[_c('strong',[_v("Command Parsing")]),_v(": Leveraged the command parsing logic from AB3, adapting it to handle the additional commands required for our project.")]),_v(" "),_c('li',[_c('strong',[_v("Storage")]),_v(": Utilized the storage mechanisms from AB3, modifying them to handle the additional data types."),_c('br')]),_v(" "),_c('li',[_c('strong',[_v("Architecture Design")]),_v(": Built upon the existing architecture design from AB3, extending classes on top of the current structure.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Ritvi")]),_v(" "),_c('li',[_v("Ritvi")]),_v(" "),_c('li',[_v("Lynette")]),_v(" "),_c('li',[_v("Lynette")]),_v(" "),_c('li',[_v("Nasya")]),_v(" "),_c('li',[_v("Nasya")]),_v(" "),_c('li',[_v("Kelly")]),_v(" "),_c('li',[_v("Kelly")]),_v(" "),_c('li',[_v("Otto")]),_v(" "),_c('li',[_v("Otto")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 19:55:12 GMT+8]")])])])}
}];
