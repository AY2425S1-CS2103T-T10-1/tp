...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. Necessary field is missing")]),_v(" "),_c('ul',[_c('li',[_v("2a1. Medicontact shows an error message indicating which field is missing")]),_v(" "),_c('li',[_v("2a2. Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("2b. Wrong format in input")]),_v(" "),_c('ul',[_c('li',[_v("2b1.Medicontact shows an error message specifying the incorrect format.")]),_v(" "),_c('li',[_v("2b2. Use case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Technical: Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Performance:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Should be able to hold up to 1000 contacts without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("The response to any use action should become visible within 3 seconds.")])])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"3"}},[_c('li',[_v("Quality: The system should be easy to use for a novice who has never use CLI before")]),_v(" "),_c('li',[_v("Note to project: Security measures like encryption will not be implemented in this project\n"),_c('em',[_v("{More to be added}")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 1 Oct 2024, 22:00:05 GMT+8]")])])])}
}];
